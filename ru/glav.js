...
burgerButton.removeEventListener("click", bur2);
    ...
    function politic(event) {
        ...
        polirica.innerHTML = "1. Бот не используется в политических целях, как оружие и для незаконных целей.<br>2. Информация из бота не гарантирует 100% точности.<br>3. Вся информация которая была предоставленна боту используется для развития<br>4. Бот сделан в развлекательных целях!<br>5. IP adress, информация акккаунта (discord), y имя учетки нам неизвестно и данная информация не используется для бота.<br>6. Бот не гарантирует конфедициальность ваших паролей и данных. (Не отправляйте пароли или что то еще конфедициальное)<br>7. Бота запрещено использовать в личных комерчиских целях";
    ...
    if(document.documentElement.clientWidth < 301) {
        ...
        inforCambia.textContent = "Когда вы используете бота вы соглашаетесь с:";
    ...
    function commands(event) {
        ...
        inforCambia.textContent = "Комманды";
    ...
    if(document.documentElement.clientWidth < 301) {
        ...
        rcomma.textContent = "Пользовательские";
        ...
        dcomma.textContent = "Разработчики";
    ...
    function block1() {
       ...
       uj4as2.textContent = "Замутить чела за нарушение правил";
       ...
       cj4as2.textContent = "Забанить человека";
       ...
       oj4as2.textContent = "Выгнать человека";
    ...
    function block2() {
        ...
        gomma2.className = "title";
        gomma2.textContent = "Пользователские";
        divah.append(gomma2); 
       ...
       uj4as2.className = "rou";
       uj4as2.textContent = "Список доступных комманд";
       ...
       cj4as2.className = "rou";
       cj4as2.textContent = "Переводчик онлайн";
       ...
       oj4as2.className = "rou";
       oj4as2.textContent = "Проверить свой код на ошибки";
    ...
    function block3() {
       ...
       uj4as2.className = "rou";
       uj4as2.textContent = "Баланс экономики";
       ...
       cj4as2.className = "rou";
       cj4as2.textContent = "Поиграть в бутылочку";
       ...
       oj4as2.className = "rou";
       oj4as2.textContent = "Pаботать экономика";
